...
public abstract  class convertNum2LitSMFem {
 private static final String[] UNIDADES = { "", "un ", "dos ", "tres ",
    ...
    public static String convertNumberToLetterSM(String number)
            throws NumberFormatException {
        return convertNumberToLetterSM(Double.parseDouble(number)).toLowerCase();
    }
     ...
     */
    public static String convertNumberToLetterSM(double doubleNumber)
            throws NumberFormatException {
