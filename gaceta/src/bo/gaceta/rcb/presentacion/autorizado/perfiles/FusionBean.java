...
public class FusionBean implements Serializable {
    ...
    public void registraPublicacion() {
        if (aceptacion) {
            try {
                ...
                String TituloPublica = "Fusión de la Sociedad " + usuarioSesion.getSociedadConstituye();
                publicacionRegistro.setTituloPublica(TituloPublica);
                String resumenPublica = "Fusión de la Sociedad: " + usuarioSesion.getSociedadConstituye();
    ...
    public void generaPreview() {
        ...
        txtVistaPrevia = "PUBLICACION DEL TESTIMONIO DE FUSIÓN  " + "\n"
                + " -----------------------------------------------------------------------------------\n"
                + "INTRODUCCION NOTARIAL" + "\n"
                + introNot + "\n"
                + "DESCRIPCION TEXTUAL DE LA FUSIÓN CONFORME A LA CLAUSULA RESPECTIVA" + "\n"
                + descr1 + "\n"
                + "DATOS DEL ACTA" + "\n"
