...
@Named(value = "disolucionLiquidacionBean")
@ViewScoped
public class DisolucionLiquidacionBean implements Serializable {
    ...
    public DisolucionLiquidacionBean() {
    ...
    public void cargaMunipDoc(ValueChangeEvent evento) {
        ...
        try {
            ...
            Logger.getLogger(DisolucionLiquidacionBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void registraPublicacion() {
        if (aceptacion) {
            try {
                ...
                String TituloPublica = "Disolución y Liquidación de la Sociedad " + usuarioSesion.getSociedadConstituye();
                publicacionRegistro.setTituloPublica(TituloPublica);
                String resumenPublica = "Disolución y Liquidación de la Sociedad : " + usuarioSesion.getSociedadConstituye();
    ...
    public void generaPreview() {
        ...
        txtVistaPrevia = "PUBLICACION DEL TESTIMONIO DE DISOLUCION Y LIQUIDACION DE SOCIEDAD  " + "\n"
                + " -----------------------------------------------------------------------------------\n"
                + "INTRODUCCION NOTARIAL" + "\n"
                + introNot + "\n"
                + "DESCRIPCIÓN TEXTUAL DE LA DISOLUCIÓN Y LIQUIDACIÓN DE SOCIEDAD CONFORME A LA CLAUSULA RESPECTIVA" + "\n"
                + descr1 + "\n"
                + "DATOS DEL ACTA" + "\n"
