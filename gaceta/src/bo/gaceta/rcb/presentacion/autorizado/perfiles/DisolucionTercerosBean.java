...
@Named(value = "disolucionTercerosBean")
@ViewScoped
public class DisolucionTercerosBean implements Serializable {
    ...
    public void cargaMunipDoc(ValueChangeEvent evento) {
        ...
        try {
            ...
            Logger.getLogger(DisolucionTercerosBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void registraPublicacion() {
        if (aceptacion) {
            try {
                ...
                String TituloPublica = "Disolución a efecto respecto a terceros de la Sociedad " + usuarioSesion.getSociedadConstituye();
                publicacionRegistro.setTituloPublica(TituloPublica);
                String resumenPublica = "Disolución a efecto respecto a terceros de la Sociedad : " + usuarioSesion.getSociedadConstituye();
    ...
    public void generaPreview() {
        ...
        txtVistaPrevia = "PUBLICACION DEL TESTIMONIO DE DISOLUCIÓN A EFECTO RESPECTO A TERCEROS   " + "\n"
                + " -----------------------------------------------------------------------------------\n"
                + "INTRODUCCION NOTARIAL" + "\n"
                + introNot + "\n"
                + "DESCRIPCION TEXTUAL DE LA DISOLUCIÓN A EFECTO RESPECTO A TERCEROS  CONFORME A LA CLAUSULA RESPECTIVA" + "\n"
                + descr1 + "\n"
                + "DATOS DEL ACTA" + "\n"
