...
public class ModificacionBean implements Serializable {
    ...
    public void registraPublicacion() {
        if (aceptacion) {
            try {
                ...
                String TituloPublica = "Modificación de Constitución de Sociedad de Responsabilidad Limitada" + usuarioSesion.getSociedadConstituye();
                ...
                FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Código de Publicación", txtMensajeResultado);
                RequestContext.getCurrentInstance().showMessageInDialog(message);
    ...
    public void generaPreview() {
        ...
        txtVistaPrevia = "PUBLICACION DEL TESTIMONIO DE MODIFICACIÓN DE SOCIEDAD DE RESPONSABILIDAD LIMITADA" + "\n"
                + " -----------------------------------------------------------------------------------\n"
                ...
                + descr1 + "\n"
                + "DATOS DEL ACTA" + "\n"
                + "Tipo de Asamblea: " + tipoJunta + ", llevada a cabo el " + df.format(fecJunta) + " en el municipio de " + distOrigen + " del Departamento de: " + txtDepartamento + "\n"
                + "Orden del Día:" + "\n"
                + "--------------" + "\n"
                + txtOrdenCompleto + "\n"
                + "CONCLUSION NOTARIAL" + "\n"
