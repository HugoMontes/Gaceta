...
@Named(value = "aumentoCapitalBean")
@ViewScoped
public class AumentoCapitalBean implements Serializable {
    ...
    public void cargaMunipDoc(ValueChangeEvent evento) {
        ...
        try {
            ...
            Logger.getLogger(AumentoCapitalBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void registraPublicacion() {
        if (aceptacion) {
            try {
                ...
                String TituloPublica = "Aumento  Capital de Sociedad de Responsabilidad Limitada" + usuarioSesion.getSociedadConstituye();
                publicacionRegistro.setTituloPublica(TituloPublica);
                String resumenPublica = "Aumento de Capital de la Sociedad:" + usuarioSesion.getSociedadConstituye();
    ...
    public void generaPreview() {
        ...
        txtVistaPrevia = "PUBLICACION DEL TESTIMONIO DE AUMENTO DE CAPITAL DE SOCIEDAD DE RESPONSABILIDAD LIMITADA" + "\n"
                + " -----------------------------------------------------------------------------------\n"
                + "INTRODUCCION NOTARIAL" + "\n"
                + introNot + "\n"
                + "MONTO DE CAPITAL SOCIAL CONFORME AL AUMENTO DE REALIZADO" + "\n"
                + descr1 + "\n"
                + "COMPOSICIÓN SOCIETARIA POR EFECTO DEL AUMENTO DE CAPITAL" + "\n"
                + descr2 + "\n"
                + "DATOS DEL ACTA" + "\n"
