...
@Named(value = "pubTransCuotasBean")
@ViewScoped
public class PubTransCuotasBean implements Serializable {
    ...
    public void cargaMunipDoc(ValueChangeEvent evento) {
        ...
        try {
            ...
            Logger.getLogger(FusionBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void registraPublicacion() {
        if (aceptacion) {
            try {
                ...
                String TituloPublica = "Transferencia de Cuotas de Capital de la Sociedad " + usuarioSesion.getSociedadConstituye();
                publicacionRegistro.setTituloPublica(TituloPublica);
                String resumenPublica = "Transferencia de Cuotas de Capital: "+usuarioSesion.getSociedadConstituye();
    ...
    public void generaPreview(){
        ...
        txtVistaPrevia="PUBLICACION DEL TESTIMONIO DE TRANSFERENCIA DE CUOTAS DE CAPITAL  "+ "\n"
              + " -----------------------------------------------------------------------------------\n"
              +"INTRODUCCION NOTARIAL"+ "\n"
              +introNot+ "\n"
              +"DESCRIPCIÓN TEXTUAL DE LA TRANSFERENCIA DE CUOTAS DE CAPITAL CONFORME A LA CLAUSULA RESPECTIVA"+ "\n"
              +descr1+ "\n"
              +"DATOS DEL ACTA"+ "\n"
